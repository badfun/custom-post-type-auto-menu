...
Upload the plugin to your site, then set the custom post type, menu, and menu parent item in 'Settings>CPT Auto Menu'.

== Frequently Asked Questions ==

= How many custom post types can I use? =
Right now the plugin only supports a single custom post type.
